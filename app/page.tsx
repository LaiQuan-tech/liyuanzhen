...
export default function HomePage() {
  return (
    <>
      ...
      <main>
        {/* ── 1. Hero ─────────────────────────────────────────── */}
        {/* ⚠️ 主標原本是她自己的詩（見下方註解保留的原文），2026-09-04 依客戶
            要求改成書名 ＋ 自傳介紹。 */}
        <section className="lz-section border-b-2 border-ink bg-mist">
          <div className="lz-wrap-wide grid items-center gap-10 md:grid-cols-[1fr_minmax(0,340px)]">
            <Reveal>
              ...
              {/* ⚠️ 2026-09-04 客戶要求：主標從她的詩改成書名，內文改成自傳介紹。
                  原本這裡是〈兩女人散步——給芳枝〉的兩行
                  （「女戰士不怕，不怕黑夜來臨／如果戰鬥，擁抱理想，黑夜即成愛人」，
                  《我來了！臺灣婦女改變了》第 6 章第 182 頁），下面還有一行出處。
                  那兩行是**她自己的詩、一個字都沒有改**，不是我們寫的標語——
                  哪天想換回來，原文與斷行方式記在這裡。
                  出處那一行也一併移除了：它是替那首詩標的，詩不在就沒有對象。 */}
              <h1 className="lz-h1-verse mt-5">《我來了！臺灣婦女改變了》</h1>
              ...
              <p className="lz-lead mt-4 !text-ink-soft">
                一起進入李元貞的婦女運動和文學創作之路。
              </p>
